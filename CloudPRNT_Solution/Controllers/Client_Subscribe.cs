...
namespace CloudPRNT_Solution.Controllers
{
    public class Client_Subscribe : Controller
    {
        ...
        public static async Task Connect_Client(MqttClientService mqttClientService)
        {
            ...
            try
            {
                ...
                // Store it in the singleton so others can reuse it
                mqttClientService.Client = managedMqttClient;
