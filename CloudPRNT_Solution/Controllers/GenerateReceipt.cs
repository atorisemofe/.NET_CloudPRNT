...
namespace CloudPRNT_Solution.Controllers
{
    public class GenerateReceipt : Controller
    {
        ...
        public string Print()
        {
            ...
            OrderContent.Append("[image: url http://res.cloudinary.com/rundoo/image/upload/v1702740475/companies/logos/gzcrtcayvzvs5etvxuci.png; width 60%; min-width 48mm]\n");
            OrderContent.Append("[magnify: width 2; height 1]\n");
            OrderContent.Append("Creative Paints & Supplies LLC\n");
            OrderContent.Append("(660) 885-2897\n");
            //OrderContent.Append("[magnify: width 3; height 2]Columns[magnify]\n");
            OrderContent.Append("[magnify: width 1; height 1\n");
            ...
            //OrderContent.Append("Sale PK3GR\n");
            OrderContent.Append("[column: left 704-7194 LINZER 1\" FOAM BRUSH x 1; right $0.01]\n");
            OrderContent.Append("[align: right]\n");
            OrderContent.Append("Subtotal: $0.01\n");
            OrderContent.Append("Tax: $0.00\n");
            OrderContent.Append("Total: $0.01\n");
            OrderContent.Append("[align: center]\n");
            OrderContent.Append("Tinted and custom products are not returnable. For all other products, returns must be within 30 days of sale with receipt. Thank you for your business!\n");
            OrderContent.Append("[align: left]\n");
            OrderContent.Append("Powered by Rundoo\n");
